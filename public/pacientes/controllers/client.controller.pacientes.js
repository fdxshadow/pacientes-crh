...
angular.module('pacientes').controller('PacientesController', ['$scope', '$routeParams', '$location', 'PacientesResource', '$localStorage',
    function($scope, $routeParams, $location, PacientesResource, $localStorage) {
